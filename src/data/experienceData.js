export const experiences = [
  {
    company: "Define Labs",
    role: "Software Developer (ROR)",
    duration: "Aug 2023 - Mar 2026",
    description: [
      ...
      "Participated in application deployment, production support, and issue resolution.",
      "Maintained code quality through testing, debugging, and continuous optimization.",
    ],
  },
];