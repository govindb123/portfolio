...
function SkillCard({ skill, i }) {
  ...
  return (
    ...
    >
      <motion.div
        className="bg-[#0a0f1e] rounded-lg px-3 py-3 flex flex-col items-center border border-slate-700 hover:border-cyan-400 cursor-default group"
        whileHover={{
          rotateY: -8,
          rotateX: 4,
          y: -5,
...
function Skills() {
  return (
    <section id="skills" className="bg-[#0a0f1e] grid-bg text-white py-28">
